...
const DetailsWrapper: FC<DetailsWrapperProps> = ({ destinations }) => {
  ...
  return (
    <section className="h-full grid grid-rows-[1fr_3fr] md:grid-rows-[1fr_2fr] lg:flex gap-8 lg:flex-row py-4 sm:py-8">
      <div className="relative min-h-[100px] h-full w-1/2 place-self-center grid place-content-center">
        <Image src={destinations[destinationIndex].images.webp} alt="moon" fill className="object-contain aspect-square" />
      </div>
      <div className="md:min-w-[500px] lg:w-1/3 h-full px-5 flex flex-col gap-8 items-center lg:items-start">
